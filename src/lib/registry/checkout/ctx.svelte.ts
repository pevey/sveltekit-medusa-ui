...
export function setCheckoutContext(ctx: CheckoutContext) {
	setContext(CHECKOUT, ctx)
}
...
export function setCheckoutLineContext(ctx: CheckoutLineContext) {
	setContext(CHECKOUT_LINE, ctx)
}
